...
Migration 0007 adds nullable `payments.received_amount_in_cents`. Legacy records retain null; net payment amounts and cash-register totals remain unchanged. Change is derived from received cash minus the payment amount.
